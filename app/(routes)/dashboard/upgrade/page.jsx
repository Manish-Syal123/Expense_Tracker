      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:items-stretch md:grid-cols-2 lg:grid-cols-3 md:gap-8">
        ...
        <div className="divide-y divide-gray-200 rounded-2xl border border-gray-200 shadow-sm hover:shadow-slate-900 hover:shadow-2xl hover:ring-1 hover:border-indigo-600 hover:ring-indigo-600 hover:rounded-3xl">
          <div className="p-6 sm:px-8">
            ...
            <a
              className="mt-4 block rounded-3xl border border-indigo-600 bg-indigo-600 px-12 py-3 text-center text-sm font-medium text-white hover:bg-transparent hover:text-indigo-600 focus:outline-none focus:ring active:text-indigo-500 sm:mt-6"
              href="#"
            >
              Get Started
            </a>
